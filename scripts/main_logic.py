...
def callback_brake_power(data):
    rospy.loginfo(data)

def callback_new_environment(data):
    rospy.loginfo(data)
...
if __name__ == '__main__':
    ...
    rospy.Subscriber('sensors/hall', Bool, callback_hall)

    pub_servo = rospy.Publisher('commands/servo', HwFloatValue, queue_size=10)
    pub_buzzer = rospy.Publisher('buzzer_info', Float32, queue_size=10)
